...
- **No model lock-in** — OpenAI, Google Gemini, Anthropic Claude, xAI Grok, Moonshot Kimi, DeepSeek, OpenRouter and Ultravox speech-to-speech. Swap with a `modelName` change, or [fail over between agents automatically](docs/agent-failover.md).
