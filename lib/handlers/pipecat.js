...
class Pipecat extends Handler {
   ...
   */
  static async outbound({ instance, callerId, calledId, metadata, aplisayId, srtp }) {
    ...
    try {
      ...
      call = await Call.create({
        ...
        outboundTrunkId: aplisayId ? (process.env.APLISAY_OUTBOUND_TRUNK_ID || undefined) : undefined,
