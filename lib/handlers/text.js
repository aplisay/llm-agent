...
class TextHandler extends Handler {
  ...
  static get models() {
    return [
      Anthropic, OpenAi, Gemini, Kimi, OpenRouter, Deepseek, Xai, Typesafe
    ];
  }
  ...
  async activate() {
    throw new Error('Text agents do not listen for calls: invoke them one-shot with POST /agents/{agentId}/invoke, or chat turn-by-turn with POST /agents/{agentId}/chat');
  }
}
