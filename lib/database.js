...
InvocationLog.belongsTo(Agent, { foreignKey: 'agentId', onDelete: 'CASCADE' });
InvocationLog.belongsTo(Instance, { foreignKey: 'instanceId', onDelete: 'CASCADE' });
InvocationLog.belongsTo(Organisation, { foreignKey: 'organisationId', onDelete: 'CASCADE' });
InvocationLog.belongsTo(User, { foreignKey: 'userId', onDelete: 'CASCADE' });
