...
// Simple AES-256-GCM helpers for encrypting credentials at rest
...
PhoneRegistration.init({
  ...
  password: {
    ...
    allowNull: false,
    set(value) {
      // Avoid double-encryption if it already looks encrypted
  ...
  state: {
    type: DataTypes.ENUM,
    values: ['initial', 'registering', 'registered', 'failed'],
...
export {
  Agent, Instance, PhoneNumber, PhoneRegistration, Call, TransactionLog, User, Organisation, AuthKey, Trunk,
  Op, Sequelize,
