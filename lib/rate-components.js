...
export const TTS_ENGINES = ['elevenlabs', 'cartesia', 'deepgram', 'google', 'neuphonic'];
/**
 * Zero-price native realtime speech under its model vendor so bundled usage settles matched rather than no_line.
 * Exclude google to avoid matching paid Google TTS rates; see docs/realtime-external-tts.md.
 */
