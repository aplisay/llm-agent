 ...
 *
 * Billing: usage.prompt_tokens includes cache reads and cache writes for
 * anthropic/* too, although Anthropic's own input_tokens excludes them. Checked
 * against the reported cost on live requests, see #309.
 *
 * @class OpenRouter
