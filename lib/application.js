...
class Application {
   ...
   */
  async destroy() {
    this.logger.info({ application: this.name, live: Application.live.map(a => a.name) }, 'Destroying application');
    ...
    this.logger.info({ application: this.name, live: Application.live.map(a => a.name) }, 'Removing from live list');
    Application.live = Application.live.filter(a => a.name !== this.name);
    this.logger.info({ application: this.name, live: Application.live.map(a => a.name) }, 'Removed from live list');
  }
