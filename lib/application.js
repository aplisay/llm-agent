...
class Application {
  ...
  static async listModels() {
    let agentImplementations = Object.entries(Application.agents)
      .filter(([key, value]) => (console.log({ key, canLoad: value.implementation.canLoad(value.implementation.needKey) }, 'agent'), (!!value.implementation && value.implementation.canLoad(value.implementation.needKey).ok)));
