 ...
 * @param {object} [opts]
 */
export async function maybeFireBalanceCallbacks(org, previousMicros, nextMicros, { log = defaultLogger } = {}) {
  try {
    ...
    for (const event of events) {
      ...
      await sendCallHook({ callHook: { url: cfg.callbackUrl }, payload, logger: log });
    }
  } catch (err) {
