...
/**
 * A stale heartbeat means unknown capability, not absence of the trace API; allow discovery to retry. See PR #265.
 */
...
export async function resolveRegistrationForHandle({
  ...
  // Use userOwnsRow: two null organisation ids must not grant access across unrelated tenants. See PR #265.
...
/**
 * Preserve actionable node statuses and Retry-After; return true once the response is sent. See PR #265.
 */
